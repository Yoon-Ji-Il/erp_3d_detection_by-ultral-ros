...
#include "ultralytics_ros/msg/detail/yolo_result__rosidl_typesupport_fastrtps_c.h"
...
using _YoloResult__ros_msg_type = ultralytics_ros__msg__YoloResult;
...
size_t get_serialized_size_ultralytics_ros__msg__YoloResult(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _YoloResult__ros_msg_type * ros_message = static_cast<const _YoloResult__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _YoloResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ultralytics_ros__msg__YoloResult(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ultralytics_ros
size_t max_serialized_size_ultralytics_ros__msg__YoloResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ultralytics_ros__msg__YoloResult;
    is_plain =
      (
...
static size_t _YoloResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ultralytics_ros__msg__YoloResult(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ultralytics_ros, msg, YoloResult)() {
